...
namespace StockMonitoringCommunity.Classes
{
    public static class InitialDatagridview
    {
        ...
        public static void Pattern_1(string[] col_head, string[] property, int[] col_width, DataGridView dataGridView2)
        {
            ...
            for (int i = 0; i < col_head.Length; i++) 
            {
                ...
                dataGridView2.Columns[i].DataPropertyName = property[i];
            ...
            dataGridView2.DefaultCellStyle.Font = new Font("Tahoma", 8);
            dataGridView2.ColumnHeadersDefaultCellStyle.Font = new Font("Tahoma", 8);
